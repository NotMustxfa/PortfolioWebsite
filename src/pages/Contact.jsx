...
const ContactInfo = () => {
  return (
    <motion.div
      ...
      className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-sm hover:shadow-lg transition-all duration-300"
    >
      ...
      <div className="space-y-6">
        <motion.a 
          ...
          whileHover={{ x: 5 }}
          className="flex items-center gap-3 text-gray-600 dark:text-gray-300 hover:text-primary transition-colors duration-200"
        >
  ...
  return (
    ...
    >
      ...
      <div className="space-y-4">
        <motion.a
          href="https://linkedin.com/in/mustafa-pitolwala-6872472b2"
          target="_blank"
        ...
        >
          ...
          <div>
            ...
            <div className="font-medium">mustafa-pitolwala-6872472b2</div>
          </div>
          <ArrowTopRightOnSquareIcon className="h-4 w-4 ml-auto" />
        </motion.a>
        
        <motion.a
          href="https://github.com/NotMustxfa"
          target="_blank"
          rel="noopener noreferrer"
          whileHover={{ x: 5 }}
          className="flex items-center gap-3 text-gray-600 dark:text-gray-300 hover:text-primary transition-colors duration-200"
        >
          ...
          <div>
            ...
            <div className="font-medium">NotMustxfa</div>
          </div>
          <ArrowTopRightOnSquareIcon className="h-4 w-4 ml-auto" />
        </motion.a>
      </div>
